        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }}>
          <Reveal mode="animate">
            <p className="font-mono text-[0.65rem] text-text-tertiary uppercase tracking-wider">
              Australian-owned · Built on site
            </p>
          </Reveal>
          <Reveal mode="animate" delay={0.1} className="mt-6">
            <h2 className="mx-auto max-w-4xl text-balance text-4xl tracking-tighter md:text-6xl lg:text-7xl">
              Come see what one platform can do.
            </h2>
          </Reveal>
          <Reveal mode="animate" delay={0.2} className="mt-7">
            <p className="mx-auto max-w-xl text-balance text-text-secondary leading-relaxed">
              Book a demo and we'll walk you from the daily pre-start to ISO certification — and you
              can meet the people building it.
            </p>
          </Reveal>
          <Reveal mode="animate" delay={0.3} className="mt-10">
